...
RSpec.describe 'Searching sellers', type: :feature, js: true do
  ...
  let!(:seller_1) { create(:active_seller, name: 'Construction Ltd', summary: 'Buildings', start_up: false) }
  let!(:seller_2) { create(:active_seller, name: 'Cloud Ltd', summary: 'Digital', start_up: true) }
