...
RSpec.describe Sellers::SellerApplication::Tailor::Contract::Industry do
  let(:seller) { create(:inactive_seller) }
  let(:application) { create(:seller_application, seller: seller) }

  subject { Sellers::SellerApplication::Tailor::Contract::Industry.new(application: application, seller: seller) }
