...
RSpec.describe Sellers::SellerApplication::Contract::Documents do

  let(:seller) { create(:inactive_seller) }
  let(:application) { create(:seller_application, seller: seller) }

  subject { Sellers::SellerApplication::Contract::Documents.new(application: application, seller: seller) }
