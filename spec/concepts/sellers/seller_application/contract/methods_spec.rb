...
RSpec.describe 'Sellers::SellerApplication::Contract::Methods' do
  skip "is skipped pending update of seller onboarding contract specs" do
    ...
    subject { Sellers::SellerApplication::Contract::Methods.new(application: application, seller: seller) }
