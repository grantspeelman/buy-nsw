...
RSpec.describe 'Sellers::SellerApplication::Contract::BusinessInfo' do
  skip "is skipped pending update of seller onboarding contract specs" do
    ...
    subject { Sellers::SellerApplication::Contract::BusinessInfo.new(application: application, seller: seller) }
